defmodule TopcvWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use TopcvWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import TopcvWeb.ConnCase
    end
  end

  setup tags do
    Topcv.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_account(%{conn: conn}) do
    account = Topcv.AccountsFixtures.account_fixture()
  ...
  def log_in_account(conn, account) do
    token = Topcv.Accounts.generate_account_session_token(account)
