defmodule TopcvWeb.AccountAuthTest do
  use TopcvWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Topcv.Accounts
  alias TopcvWeb.AccountAuth
  import Topcv.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TopcvWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TopcvWeb.Endpoint.subscribe(live_socket_id)
