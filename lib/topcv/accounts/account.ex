defmodule Topcv.Accounts.Account do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Topcv.Repo)
  ...
  """
  def valid_password?(%Topcv.Accounts.Account{hashed_password: hashed_password}, password)
