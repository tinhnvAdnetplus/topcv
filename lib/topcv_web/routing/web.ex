defmodule TopcvWeb.Routing.Web do
  use TopcvWeb, :router
  ...
  if Application.compile_env(:topcv, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard("/dashboard", metrics: TopcvWeb.Telemetry)
  ...
  scope "/", TopcvWeb do
    ...
    live_session :current_account,
      on_mount: [{TopcvWeb.AccountAuth, :mount_current_account}] do
